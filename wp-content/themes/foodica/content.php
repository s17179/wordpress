<article id="post-<?php the_ID(); ?>" <?php post_class('regular-post'); ?>>
    ...
    <section class="entry-body">
        ...
        <div class="entry-meta">
            ...
            <?php printf( '<span class="entry-author">%s ', __( 'dodał', 'foodica' ) ); the_author_posts_link(); print('</span>'); ?>

            <?php

            if ( ! post_password_required() && ( comments_open() || 0 != get_comments_number() ) ) :
                echo '<span class="comments-link">';
                comments_popup_link( __('0 komentarzy', 'foodica'), __('1 komentarz', 'foodica'), __('% komentarzy', 'foodica'), '', __('Comments are Disabled', 'foodica'));
        ...
        <div class="readmore_button">
            ...
            <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'foodica' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php esc_html_e('Zobacz', 'foodica'); ?></a>
        </div>
